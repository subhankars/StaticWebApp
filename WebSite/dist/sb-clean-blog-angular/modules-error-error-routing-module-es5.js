  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["modules-error-error-routing-module"], {
    ...
    function nNA(module, __webpack_exports__, __webpack_require__) {
      ...
      var ROUTES = [{
        ...
        data: {
          title: 'Error 401 - Subhankar Sarkar'
        }
      }, {
        path: '404',
        canActivate: [],
        ...
        data: {
          title: 'Error 404 - Subhankar Sarkar'
        }
      }, {
        path: '500',
        canActivate: [],
        ...
        data: {
          title: 'Error 500 - Subhankar Sarkar'
        }
      }, {
        path: '**',
        pathMatch: 'full',
