...
export class BlogService {
    ...
    getPosts$(): Observable<Post[]> {
        return this.http
            .get<ResultsPost[]>(`${this.configService.config.sbCleanBlogNodeURL}/StaticWebAppBackend`)
            .pipe(
                map(posts =>
    ...
    createPost$(payload: CreatePostPayload): Observable<Post | Error> {
        return this.http
            .post<ResultsPost>(
                `${this.configService.config.sbCleanBlogNodeURL}/StaticWebAppBackend/`,
                payload
            )
            .pipe(
    ...
    updatePost$(post: Post, payload: UpdatePostPayload): Observable<undefined | Error> {
        return this.http
            .put<undefined>(
                `${this.configService.config.sbCleanBlogNodeURL}/StaticWebAppBackend/${post.id}`,
                payload
            )
    ...
    deletePost$(id: UUID): Observable<undefined | Error> {
        return this.http
            .delete<undefined>(
                `${this.configService.config.sbCleanBlogNodeURL}/StaticWebAppBackend/${id}`
            )
